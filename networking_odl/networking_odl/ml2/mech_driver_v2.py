...
from networking_odl.maxinet import StatelessEventHandlerForMininet
...
class OpenDaylightMechanismDriver(api.MechanismDriver):
    ...
    def initialize(self):
        ...
        self.sg_handler = callback.OdlSecurityGroupsHandler(self.sync_from_callback_precommit,self.sync_from_callback_postcommit)
        self._mininet_logger = LOG
        self.mininet_handler = StatelessEventHandlerForMininet.StatelessEventHandlerForMininet()
    ...
    def setup_mininet_logger(self, name, log_file, level=logging.INFO):
